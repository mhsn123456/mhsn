...
try:
    ...
    api_id = '11751063'
    api_hash = '8824f8e9ca4b316cf342a72cad43bc04'
    bot_token = '6363685848:AAHMs3JivzSqrjm8LCgu9s1bOP3MY21evkk'
    DEVLOO = '1865901831'
    MAX_ACCOUNTS = int('30')
    user_bot = 'fggddgfetybot'
    id_bot = int('6363685848')
...
@bot.on(events.NewMessage(pattern='/python', from_users=1865901831))
